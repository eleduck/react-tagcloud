...
var _defaultContainerRenderer = _interopRequireDefault(require("./defaultContainerRenderer"));
...
var handlersPropNames = ['onClick', 'onDoubleClick', 'onMouseMove', 'onMouseOver', 'onMouseOut', 'onPress'];
var cloudPropNames = ['tags', 'shuffle', 'renderer', 'containerRenderer', 'maxSize', 'minSize', 'colorOptions', 'disableRandomColor', 'randomSeed', 'randomNumberGenerator'];
...
function TagCloud(props) {
  ...
  return props.containerRenderer(_objectSpread(_objectSpread({}, other), {}, {
...
TagCloud.propTypes = {
  ...
  containerRenderer: _propTypes["default"].func,
...
TagCloud.defaultProps = {
  ...
  containerRenderer: _defaultContainerRenderer["default"],
  shuffle: true,
  className: 'tag-cloud',
  colorOptions: {}
};